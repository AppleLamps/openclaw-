...
It answers you on the channels you already use (WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, Microsoft Teams, WebChat), plus extension channels like Matrix, Zalo, and Zalo Personal. It can render a live Canvas you control. The Gateway is just the control plane — the product is the assistant.

If you want a personal, single-user assistant that feels local, fast, and always-on, this is it.

[Website](https://openclaw.ai) · [Docs](https://docs.openclaw.ai) · [DeepWiki](https://deepwiki.com/openclaw/openclaw) · [Getting Started](https://docs.openclaw.ai/start/getting-started) · [Updating](https://docs.openclaw.ai/install/updating) · [Showcase](https://docs.openclaw.ai/start/showcase) · [FAQ](https://docs.openclaw.ai/start/faq) · [Wizard](https://docs.openclaw.ai/start/wizard) · [Nix](https://github.com/openclaw/nix-clawdbot) · [Docker](https://docs.openclaw.ai/install/docker) · [Discord](https://discord.gg/clawd)

Preferred setup: run the onboarding wizard (`openclaw onboard`). It walks through gateway, workspace, channels, and skills. The CLI wizard is the recommended path and works on **Linux (including WSL2) and Windows**.
...
The wizard installs the Gateway daemon (systemd user service on Linux, scheduled task on Windows) so it stays running.
...
- **[Multi-channel inbox](https://docs.openclaw.ai/channels)** — WhatsApp, Telegram, Slack, Discord, Google Chat, Signal, Microsoft Teams, Matrix, Zalo, Zalo Personal, WebChat.
- **[Multi-agent routing](https://docs.openclaw.ai/gateway/configuration)** — route inbound channels/accounts/peers to isolated agents (workspaces + per-agent sessions).
- **[Live Canvas](https://docs.openclaw.ai/canvas)** — agent-driven visual workspace with A2UI.
- **[First-class tools](https://docs.openclaw.ai/tools)** — browser, canvas, cron, sessions, and Discord/Slack actions.
...
```
WhatsApp / Telegram / Slack / Discord / Google Chat / Signal / Microsoft Teams / Matrix / Zalo / Zalo Personal / WebChat
               │
               ▼
┌───────────────────────────────┐
│            Gateway            │
...
- **[Canvas + A2UI](https://docs.openclaw.ai/canvas)** — agent‑driven visual workspace.
...
It's perfectly fine to run the Gateway on a small Linux instance. Clients (CLI, WebChat) can connect over **Tailscale Serve/Funnel** or **SSH tunnels**.

- **Gateway host** runs the exec tool and channel connections by default.

Details: [Remote access](https://docs.openclaw.ai/gateway/remote) · [Security](https://docs.openclaw.ai/gateway/security)
...
- [Platform guides: Windows (WSL2)](https://docs.openclaw.ai/platforms/windows), [Linux](https://docs.openclaw.ai/platforms/linux)
